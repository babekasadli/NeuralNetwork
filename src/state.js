...
exports.State = exports.problems = exports.Problem = exports.Type = exports.getKeyFromValue = exports.regDatasets = exports.datasets = exports.regularizations = exports.activations = void 0;
var nn = require("./nn");
...
var State = (function () {
    ...
    State.prototype.serialize = function () {
        ...
        State.PROPS.forEach(function (_a) {
            ...
            props.push("".concat(name, "=").concat(value));
        });
        getHideProps(this).forEach(function (prop) {
            props.push("".concat(prop, "=").concat(_this[prop]));
        });
